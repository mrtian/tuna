...
class AnimatedLogo extends StatelessWidget {
  ...
  List<ValueNotifier<double>?> opacityNotify = List.filled(16, null);
  List<Animation<double>?> opacity = List.filled(16,null);
  double? opacityValue;
            ...
            child: Opacity(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: (color!=null && color.value!=null)?color.value:Colors.transparent,
